...
def load_final_sfcn_preloaded(run,task,bin_min,bin_max,reinit_with_scaling=None):
...
def train_final_sfcn_preloaded(train_loader,val_loader,hps): 
    ...
    model=load_final_sfcn_preloaded(hps['run'],hps['task'],hps['bin_min'],hps['bin_max'],hps.get('reinit_with_scaling',None))
