...
#$ -o experiments/ukb/age/direct_transfer/test_direct_transfer_ukb/test_direct_transfer_ukb20210329_1436.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ukb/age/direct_transfer/test_direct_transfer_ukb/test_direct_transfer_ukb20210329_1436.json
