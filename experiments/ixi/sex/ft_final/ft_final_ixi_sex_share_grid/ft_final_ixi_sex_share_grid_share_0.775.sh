...
#$ -o experiments/ixi/sex/ft_final/ft_final_ixi_sex_share_grid/ft_final_ixi_sex_share_grid_share_0.775.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/sex/ft_final/ft_final_ixi_sex_share_grid/ft_final_ixi_sex_share_grid20210407_1202_share_0.775.json
