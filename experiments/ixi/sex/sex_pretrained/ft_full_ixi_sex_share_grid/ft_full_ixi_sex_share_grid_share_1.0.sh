...
#$ -o experiments/ixi/sex/sex_pretrained/ft_full_ixi_sex_share_grid/ft_full_ixi_sex_share_grid_share_1.0.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/sex/sex_pretrained/ft_full_ixi_sex_share_grid/ft_full_ixi_sex_share_grid20210407_1155_share_1.0.json
