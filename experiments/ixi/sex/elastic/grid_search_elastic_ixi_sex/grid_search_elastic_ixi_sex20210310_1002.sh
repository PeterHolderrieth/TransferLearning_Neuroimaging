...
#$ -o experiments/ixi/sex/elastic/grid_search_elastic_ixi_sex/grid_search_elastic_ixi_sex20210310_1002.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/sex/elastic/grid_search_elastic_ixi_sex/grid_search_elastic_ixi_sex20210310_1002.json
