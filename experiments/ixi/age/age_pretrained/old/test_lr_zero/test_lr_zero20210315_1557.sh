...
#$ -o experiments/ixi/age/age_pretrained/test_lr_zero/test_lr_zero20210315_1557.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/age_pretrained/test_lr_zero/test_lr_zero20210315_1557.json
