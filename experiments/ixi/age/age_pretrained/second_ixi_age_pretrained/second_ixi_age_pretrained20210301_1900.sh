...
#$ -o experiments/ixi/age/age_pretrained/second_ixi_age_pretrained/second_ixi_age_pretrained20210301_1900.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/age_pretrained/second_ixi_age_pretrained/second_ixi_age_pretrained20210301_1900.json
