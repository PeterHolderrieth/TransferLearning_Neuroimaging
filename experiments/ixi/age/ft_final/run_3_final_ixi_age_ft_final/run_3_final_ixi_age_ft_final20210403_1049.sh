...
#$ -o experiments/ixi/age/ft_final/run_3_final_ixi_age_ft_final/run_3_final_ixi_age_ft_final20210403_1049.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/ft_final/run_3_final_ixi_age_ft_final/run_3_final_ixi_age_ft_final20210403_1049.json
