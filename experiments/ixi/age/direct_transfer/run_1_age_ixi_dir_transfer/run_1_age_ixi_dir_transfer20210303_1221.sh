...
#$ -o experiments/ixi/age/direct_transfer/run_1_age_ixi_dir_transfer/run_1_age_ixi_dir_transfer20210303_1221.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/direct_transfer/run_1_age_ixi_dir_transfer/run_1_age_ixi_dir_transfer20210303_1221.json
