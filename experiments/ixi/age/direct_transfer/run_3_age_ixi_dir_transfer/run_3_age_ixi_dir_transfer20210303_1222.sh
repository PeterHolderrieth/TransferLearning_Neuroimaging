...
#$ -o experiments/ixi/age/direct_transfer/run_3_age_ixi_dir_transfer/run_3_age_ixi_dir_transfer20210303_1222.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/direct_transfer/run_3_age_ixi_dir_transfer/run_3_age_ixi_dir_transfer20210303_1222.json
