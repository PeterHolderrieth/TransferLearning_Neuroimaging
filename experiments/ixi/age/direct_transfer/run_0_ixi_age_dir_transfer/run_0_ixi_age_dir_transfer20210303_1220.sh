...
#$ -o experiments/ixi/age/direct_transfer/run_0_ixi_age_dir_transfer/run_0_ixi_age_dir_transfer20210303_1220.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/direct_transfer/run_0_ixi_age_dir_transfer/run_0_ixi_age_dir_transfer20210303_1220.json
