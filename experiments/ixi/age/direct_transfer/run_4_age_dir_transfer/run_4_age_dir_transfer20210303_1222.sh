...
#$ -o experiments/ixi/age/direct_transfer/run_4_age_dir_transfer/run_4_age_dir_transfer20210303_1222.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/direct_transfer/run_4_age_dir_transfer/run_4_age_dir_transfer20210303_1222.json
