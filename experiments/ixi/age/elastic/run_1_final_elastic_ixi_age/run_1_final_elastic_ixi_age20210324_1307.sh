...
#$ -o experiments/ixi/age/elastic/run_1_final_elastic_ixi_age/run_1_final_elastic_ixi_age20210324_1307.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/ixi/age/elastic/run_1_final_elastic_ixi_age/run_1_final_elastic_ixi_age20210324_1307.json
