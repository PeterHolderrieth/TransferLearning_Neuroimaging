...
#$ -o experiments/oasis/sex/sex_pretrained/test_increasing_dropout/test_increasing_dropout20210320_1306.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/sex/sex_pretrained/test_increasing_dropout/test_increasing_dropout20210320_1306.json
