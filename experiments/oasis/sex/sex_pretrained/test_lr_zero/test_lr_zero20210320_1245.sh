...
#$ -o experiments/oasis/sex/sex_pretrained/test_lr_zero/test_lr_zero20210320_1245.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/sex/sex_pretrained/test_lr_zero/test_lr_zero20210320_1245.json
