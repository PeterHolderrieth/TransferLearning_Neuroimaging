...
#$ -o experiments/oasis/progmci/elastic/test_progmci_exp/test_progmci_exp20210316_1451.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/progmci/elastic/test_progmci_exp/test_progmci_exp20210316_1451.json
