...
#$ -o experiments/oasis/age/direct_transfer/run_0_/run_0_20210220_1438.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/age/direct_transfer/run_0_/run_0_20210220_1438.json -test 1
