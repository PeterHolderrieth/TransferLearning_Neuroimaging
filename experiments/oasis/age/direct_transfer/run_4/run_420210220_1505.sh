...
#$ -o experiments/oasis/age/direct_transfer/run_4/run_420210220_1505.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/age/direct_transfer/run_4/run_420210220_1505.json -test 1
