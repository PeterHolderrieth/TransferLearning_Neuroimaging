...
#$ -o experiments/oasis/age/ft_final/ft_final_oasis_age_/ft_final_oasis_age__share_0.8875.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/age/ft_final/ft_final_oasis_age_/ft_final_oasis_age_20210407_1145_share_0.8875.json
