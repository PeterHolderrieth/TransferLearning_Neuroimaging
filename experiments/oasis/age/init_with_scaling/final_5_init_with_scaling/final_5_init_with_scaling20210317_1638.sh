...
#$ -o experiments/oasis/age/init_with_scaling/final_5_init_with_scaling/final_5_init_with_scaling20210317_1638.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/oasis/age/init_with_scaling/final_5_init_with_scaling/final_5_init_with_scaling20210317_1638.json
