...
#$ -o experiments/abide/sex/sex_pretrained/sixth_experiment_abide_sex/sixth_experiment_abide_sex20210305_1319.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/sex/sex_pretrained/sixth_experiment_abide_sex/sixth_experiment_abide_sex20210305_1319.json
