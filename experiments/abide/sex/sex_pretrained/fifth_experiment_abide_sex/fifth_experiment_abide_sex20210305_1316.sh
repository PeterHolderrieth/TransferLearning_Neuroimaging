...
#$ -o experiments/abide/sex/sex_pretrained/fifth_experiment_abide_sex/fifth_experiment_abide_sex20210305_1316.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/sex/sex_pretrained/fifth_experiment_abide_sex/fifth_experiment_abide_sex20210305_1316.json
