...
#$ -o experiments/abide/sex/sex_pretrained/seventh_run_experiment/seventh_run_experiment20210305_1844.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/sex/sex_pretrained/seventh_run_experiment/seventh_run_experiment20210305_1844.json
