...
#$ -o experiments/abide/sex/elastic/elastic_grid_sex_abide/elastic_grid_sex_abide20210308_1509.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/sex/elastic/elastic_grid_sex_abide/elastic_grid_sex_abide20210308_1509.json
