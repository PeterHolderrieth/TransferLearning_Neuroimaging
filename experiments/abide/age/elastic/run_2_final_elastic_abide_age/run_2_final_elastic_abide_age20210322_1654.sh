...
#$ -o experiments/abide/age/elastic/run_2_final_elastic_abide_age/run_2_final_elastic_abide_age20210322_1654.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/elastic/run_2_final_elastic_abide_age/run_2_final_elastic_abide_age20210322_1654.json
