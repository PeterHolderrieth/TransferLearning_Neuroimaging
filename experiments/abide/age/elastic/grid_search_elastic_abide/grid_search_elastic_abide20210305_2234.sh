...
#$ -o experiments/abide/age/elastic/grid_search_elastic_abide/grid_search_elastic_abide20210305_2234.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/elastic/grid_search_elastic_abide/grid_search_elastic_abide20210305_2234.json
