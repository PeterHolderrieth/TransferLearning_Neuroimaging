...
#$ -o experiments/abide/age/age_pretrained/exp_2_abide_age_ft_step/exp_2_abide_age_ft_step20210323_1031.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/exp_2_abide_age_ft_step/exp_2_abide_age_ft_step20210323_1031.json
