...
#$ -o experiments/abide/age/age_pretrained/exp_4_abide_age_ft_step/exp_4_abide_age_ft_step20210323_1034.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/exp_4_abide_age_ft_step/exp_4_abide_age_ft_step20210323_1034.json
