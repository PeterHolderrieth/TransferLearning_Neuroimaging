...
#$ -o experiments/abide/age/age_pretrained/exp_6_abide_age_ft_step/exp_6_abide_age_ft_step20210324_1121.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/exp_6_abide_age_ft_step/exp_6_abide_age_ft_step20210324_1121.json
