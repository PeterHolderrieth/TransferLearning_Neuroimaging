...
#$ -o experiments/abide/age/age_pretrained/fifth_run_abide_age/fifth_run_abide_age20210301_1857.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/fifth_run_abide_age/fifth_run_abide_age20210301_1857.json
