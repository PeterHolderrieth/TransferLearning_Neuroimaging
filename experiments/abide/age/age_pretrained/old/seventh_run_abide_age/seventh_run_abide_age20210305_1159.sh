...
#$ -o experiments/abide/age/age_pretrained/seventh_run_abide_age/seventh_run_abide_age20210305_1159.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/seventh_run_abide_age/seventh_run_abide_age20210305_1159.json
