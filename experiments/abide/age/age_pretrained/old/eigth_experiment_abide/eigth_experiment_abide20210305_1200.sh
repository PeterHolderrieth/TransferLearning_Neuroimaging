...
#$ -o experiments/abide/age/age_pretrained/eigth_experiment_abide/eigth_experiment_abide20210305_1200.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/eigth_experiment_abide/eigth_experiment_abide20210305_1200.json
