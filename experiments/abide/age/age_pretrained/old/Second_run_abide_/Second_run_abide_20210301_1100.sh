...
#$ -o experiments/abide/age/age_pretrained/Second_run_abide_/Second_run_abide_20210301_1100.log
...
python ~/TransferLearning_Neuroimaging/main.py -deb full -con experiments/abide/age/age_pretrained/Second_run_abide_/Second_run_abide_20210301_1100.json
